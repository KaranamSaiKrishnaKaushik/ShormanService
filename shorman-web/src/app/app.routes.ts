...
export const routes: Routes = [
  ...
  { path: 'orders', loadComponent: () => import('./features/orders/orders.component').then(m => m.OrdersComponent), canActivate: [roleGuard], data: { roles: ['Customer', 'Rider'], menuKey: 'orders' } },
  { path: 'history-stats', loadComponent: () => import('./features/history-stats/history-stats.component').then(m => m.HistoryStatsComponent), canActivate: [roleGuard], data: { roles: ['SuperAdmin', 'Admin', 'Customer'] } },
